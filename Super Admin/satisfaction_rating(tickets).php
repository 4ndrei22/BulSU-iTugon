          ...
          <div class="col-md-12">
            <div class="card vh-100" style="max-height:850px; min-height:300px; overflow:auto;">
              <div class="card-header">
                <h4 class="card-title"> BulSU iTugon Mobile App Ticket Feedback </h4>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                                    <?php
                                        require_once("connect.php");
                                        $sqlQuery = "SELECT * FROM ticketinfo INNER JOIN accountcreation ON ticketinfo.ticket_owner = accountcreation.unique_id WHERE NOT ticketinfo.rating = 0 ORDER BY ticketinfo.rating DESC";
                                            ...
                                            <table class="table" >
                                                ...
                                                <tbody>
                                                    <tr class="<?php if(isset($classname)) echo $classname;?>">
                                                        ...
                                                        <td class="text-wrap"style="word-wrap: break-word; "><?php echo $row['subject']; ?></td>
                                                        <td><?php echo $row['rating']; ?></td>
                                                        <td class="text-wrap"style="word-wrap: break-word; "><?php echo $row['comments']; ?></td>
                                                    </tr>
                                                    <?php
                                                    $i++;
                                                    }
