...
<?php
    ...
    if(!empty($_POST['status'])) {
        ...
        if($selected == 'Assigned' ||$selected == 'Pending'||$selected == 'Reopened' ){
            $sortingcondition = "AND ticketinfo.status = '$selected'";
        }else{
            $sortingcondition;
        }
                ...
                <form action="" method="post">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 pr-1 pt-2">
                            <div class="form-group">
                                <select class="form-control " name="status">
                                    <option value="" disabled selected>Sort tickets</option>
                        ...
                        <div class="col-md-6 pl-1">
                            <div class="form-group">
                                <input class="btn bg-white" type="submit" name="submit" value="Sort tickets"style="height:41px; color: #671e1e;">
                            </div>
                        </div>
                    </div>
                </form>
          ...
          <div class="row" id="ticket-list-div">
            <?php
              ...
              $sql = "SELECT
                        ...
                        FROM ticketinfo INNER JOIN accountcreation ON ticketinfo.ticket_owner = accountcreation.unique_id WHERE date_needed BETWEEN 2022-01-01 AND (CURRENT_DATE + INTERVAL -1 DAY) AND (ticketinfo.ticket_assignee = '{$_SESSION['U_unique_id']}') $sortingcondition  $sortingcondition2 AND (NOT ticketinfo.status = 'Closed')";
