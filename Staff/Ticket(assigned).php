...
<?php
            ...
            <table class="table table-borderless">
                        <tbody id="tbl_body">
                            ...
                            $sql = mysqli_query($con, "SELECT 
                                                    ...
                                                    FROM ticketinfo 
                                                    INNER JOIN accountcreation ON accountcreation.unique_id = ticketinfo.ticket_owner WHERE (ticketinfo.ticket_assignee =  {$_SESSION['U_unique_id']}) AND (ticketinfo.status='Assigned') $sortingcondition1 ORDER BY ticketinfo.date_needed ASC");
 ...
 <script>
            $(document).on("keyup", "#search_param", function () {
                ...
                $.ajax({
                    url: 'search/searchResult(assigned).php',
                    type: 'POST',
