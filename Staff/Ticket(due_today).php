          ...
          <div class="row" id="ticket-list-div">
            <?php
              ...
              $sql = "SELECT
                        ...
                        FROM ticketinfo INNER JOIN accountcreation ON ticketinfo.ticket_owner = accountcreation.unique_id WHERE date_needed IN (CURRENT_DATE, CURRENT_DATE) AND ticketinfo.ticket_assignee = '{$_SESSION['U_unique_id']}' $sortingcondition $sortingcondition2 AND NOT ticketinfo.status = 'Closed'";
