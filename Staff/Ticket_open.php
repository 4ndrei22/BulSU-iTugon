  ...
  <div class="wrapper">
    ...
    ?>
     <div class="content" id="openTickets">
          ...
          <div class="" id="ticket-list-div">
            <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th><div class="row justify-content-end">
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 pr-1 pt-2">
                                                    <div class="form-group">
                                                        <input type="text"  class="form-control" placeholder="Search here..." id="search_param" autocomplete="off">
                                                    </div>
                        ...
                        <tbody id="tbl_body">
                            ...
                            $sql = mysqli_query($con, "SELECT 
                                                    ...
                                                    FROM ticketinfo 
                                                    INNER JOIN accountcreation ON accountcreation.unique_id = ticketinfo.ticket_owner WHERE ticketinfo.ticket_assignee =  {$_SESSION['U_unique_id']} $sortingcondition1 ORDER BY ticketinfo.date_needed ASC");
