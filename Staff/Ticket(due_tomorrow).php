          ...
          <div class="row" id="ticket-list-div">
            <?php
              ...
              $sql = "SELECT
                        ...
                        FROM ticketinfo INNER JOIN accountcreation ON ticketinfo.ticket_owner = accountcreation.unique_id WHERE date_needed IN (CURRENT_DATE, CURRENT_DATE + INTERVAL +1 DAY) $sortingcondition  AND ticketinfo.ticket_assignee = '{$_SESSION['U_unique_id']}' AND NOT ticketinfo.status = 'Closed'";
