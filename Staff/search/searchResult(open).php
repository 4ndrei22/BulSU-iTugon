...
if (isset($_POST['search_param'])) {
    ...
    $query = mysqli_query($con, "SELECT 
                    ...
                    FROM ticketinfo 
                    INNER JOIN accountcreation ON accountcreation.unique_id = ticketinfo.ticket_owner where (ticketinfo.status='Open') AND (ticketinfo.ticket_id like '%$search_param%' or ticketinfo.priority_lvl like '%$search_param%') order by date_needed");
    $output = '';
