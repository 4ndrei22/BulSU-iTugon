...
<body>
            ...
            <table class="table table-borderless">
                        <tbody id="tbl_body">
                            ...
                            $sql = mysqli_query($con, "SELECT 
                                                    ...
                                                    FROM ticketinfo 
                                                    INNER JOIN accountcreation ON accountcreation.unique_id = ticketinfo.ticket_owner WHERE (ticketinfo.status='Open') $sortingcondition2 ORDER BY ticketinfo.date_needed ASC");
 ...
 <script>
            $(document).on("keyup", "#search_param", function () {
                ...
                $.ajax({
                    url: 'search/searchResult(open).php',
                    type: 'POST',
